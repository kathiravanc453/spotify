  ...
  return (
    <>
      <div
        ...
        {...longPressHandlers}
        className={`group relative flex flex-col gap-3 p-4 rounded-2xl cursor-pointer transition-all duration-500 select-none
          ${isActive
        ...
        <div className="relative aspect-square rounded-xl overflow-hidden shadow-md">
          ...
          <div className={`absolute inset-0 bg-black/40 flex items-center justify-center transition-opacity duration-300
            ...
            <div className={`w-12 h-12 rounded-full flex items-center justify-center shadow-lg transition-all duration-300
              ${isCurrentlyPlaying
                ? 'scale-100'
                : 'scale-90 group-hover:scale-100 hover:scale-105'}`}
          ...
          {/* Long-press hint dot — mobile only */}
      ...
      {/* Context bottom sheet (mobile long-press) */}
      {showContext && (
