...
import { Upload, Music, Image, CheckCircle, AlertCircle, X, Plus, Loader2, TrendingUp, Star } from 'lucide-react';
...
export default function AdminUpload() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto space-y-8">
      <div>
        <h1 className="text-white text-3xl font-bold mb-2">Cloudinary Upload</h1>
        <p className="text-white/50 text-sm">Upload songs directly to your cloud and sync them to the website.</p>
      </div>
