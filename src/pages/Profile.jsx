...
// Portal helper — renders children directly into document.body, escaping any parent stacking context
...
export default function Profile() {
  ...
  return (
    <>
          ...
          <div className="fixed inset-0 z-[300] bg-[#121212] flex flex-col">
            ...
            <div className="flex flex-col items-center mt-10 px-6">
              <div className="relative">
                ...
                <button className="absolute bottom-0 right-0 w-9 h-9 bg-white rounded-lg flex items-center justify-center shadow-lg">
          ...
          >
            <button
              ...
              onClick={() => {
                setShowMenu(false);
                if (navigator.share) {
                  navigator.share({ title: 'Rhythmix Profile', url: window.location.href });
                }
              }}
            >
              <Share size={18} />
      ...
      {/* ── Main Profile View ───────────────────────────────────────── */}
      <div className="flex flex-col h-full bg-[#121212] overflow-y-auto w-full pb-8">
